...
var SCAN_PERIOD = 500; // time interval in milliseconds to check the sensor
...
//  High and low thresholds of digital PINs are
//  determined by the microcontroller (LPC1830)
//
//             ^
//             |
//      3.30 V | - - - - - - - - - - - - - - - - - - -
...
opin.rawDirection(1);   // set this PIN to output mode
opin.rawWrite(1);       // set this PIN to 3.30 V (high)
ipin.rawDirection(0);   // set this PIN to input mode
ipin.pull('pulldown');  // pull this PIN down to 0.00 V (low)
